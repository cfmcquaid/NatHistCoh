...
paramF <- c(Eq=0.10, Qs=2.50, Qz=0.00, Kz=0.02, Kr=0.10, Sc=2.00, Sq=1.00, Sz=0.01, Zk=0.01, Zs=0.00, Zq=0.02, Cy=2.00, Cs=1.00, Cm=0.10, Ym=0.60, Yc=2.10)
