...
outDB <- intervD(c(parametersB, Su=0.05))
outDBb <- intervD(c(parametersB, Su=0.025))
...
lines(outRB$int,col="blue")
lines(outCB$int,col="green")
lines(outDB$int,col="orange")
lines(outR$int,col="blue",lty=2)
lines(outC$int,col="green",lty=2)
lines(outD$int,col="orange",lty=2)


plot(outR$cum,col="blue",type="l",lty=2)
lines(outRB$cum,col="blue")
lines(outB$cum,col="red")

plot(outC$cum,col="green",type="l",lty=2)
lines(outCB$cum,col="green")
lines(outB$cum,col="red")

plot(outB$cum,col="red",type="l")
lines(outDB$cum,col="orange")
#lines(outDBb$cum,col="orange",lty=3)
lines(outD$cum,col="orange",lty=2)
