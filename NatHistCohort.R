...
Qsz <- out[which(out$source == "A" & out$variable == "Q" & out$time == 5), ]; Ssz <- out[which(out$source == "A" & out$variable == "S" & out$time == 5), ]; Ksz <- out[which(out$source == "A" & out$variable == "K" & out$time == 5), ]; Zsz <- out[which(out$source == "A" & out$variable == "Z" & out$time == 5), ]; Csz <- out[which(out$source == "A" & out$variable == "C" & out$time == 5), ]; Ysz <- out[which(out$source == "A" & out$variable == "Y" & out$time == 5), ]; Msz <- out[which(out$source == "A" & out$variable == "M" & out$time == 5), ];
(Csz$value + Ysz$value + Msz$value) / (Qsz$value + Ssz$value + Ksz$value + Zsz$value + Csz$value + Ysz$value + Msz$value)

Qsz <- out[which(out$source == "W" & out$variable == "Q" & out$time == 5), ]; Ssz <- out[which(out$source == "W" & out$variable == "S" & out$time == 5), ]; Ksz <- out[which(out$source == "W" & out$variable == "K" & out$time == 5), ]; Zsz <- out[which(out$source == "W" & out$variable == "Z" & out$time == 5), ]; Csz <- out[which(out$source == "W" & out$variable == "C" & out$time == 5), ]; Ysz <- out[which(out$source == "W" & out$variable == "Y" & out$time == 5), ]; Msz <- out[which(out$source == "W" & out$variable == "M" & out$time == 5), ];
(Csz$value + Ysz$value + Msz$value) / (Qsz$value + Ssz$value + Ksz$value + Zsz$value + Csz$value + Ysz$value + Msz$value)
